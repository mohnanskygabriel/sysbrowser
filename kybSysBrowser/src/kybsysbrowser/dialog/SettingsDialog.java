...
public class SettingsDialog extends Dialog {
	...
	public Object open() {
		...
		lblPathForBookmarksFile.setText("Cesta pre s˙bor s poloûkami v strome:");
	...
	private void createContents() {
		...
		btnSaveChanges.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent arg0) {
				InfoDialog popUpOk = new InfoDialog(shell, SWT.DIALOG_TRIM, "Zmeny uloûenÈ", "Zmeny uloûenÈ");
